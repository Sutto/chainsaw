var Chainsaw={spinderella:null,processors:{},loadExisting:false,streamURL:"",callbackCount:0,onReadyCallbacks:[],connected:false,host:"",port:{base:42340,websocket:42342},loadJSONP:function(a,b){var c=this.callbackCount++,e="chainsaw-callback-"+c,f="jsonpCallback"+c;Chainsaw[f]=function(d){typeof b=="function"&&b(d);delete Chainsaw[f];if(d=document.getElementById(e)){d.parentElement.removeChild(d);for(var g in d)delete d[g]}};c="Chainsaw."+f;c=a.indexOf("?")<0?(a="?callback="+c):a.replace("=?","="+
